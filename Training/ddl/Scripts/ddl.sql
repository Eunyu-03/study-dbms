...
create table tbl_file(
	id bigint unsigned primary key,
	file_channel varchar(255) not null,
...
create table tbl_carOwner(
	id bigint unsigned primary key,
	carOwner_name varchar(255) not null,
	carOwner_phone bigint not null,
	carOwner_address varchar(255) not null
);
...
create table tbl_car(
	...
	car_price bigint default 0,
	car_releaseDate date not null
);

create table tbl_registration(
	id bigint unsigned primary key,
	car_id bigint unsigned,
	carOwner_id bigint unsigned,
	constraint fk_car foreign key(car_id)
	references tbl_car(id),
	constraint fk_carOwner foreign key(carOwner_id)
	references tbl_carOwner(id)
);
...
create table tbli_category_b(
	id bigint unsigned primary key,
	category_b_name varchar(255) not null,
	category_a_id bigint unsigned,
	constraint fk_category_a_category_b foreign key(category_a_id)
...
create table tbl_cabinet(
	...
	constraint fk_cabinet_office foreign key(office_id)
	references tbl_office(id)
);


create table tbl_parttime(
	id bigint unsigned primary key,
	parttime_start time not null,
	parttime_end time not null,
	cabinet_id bigint unsigned,
	constraint fk_parttime_cabinet foreign key(cabinet_id)
	references tbl_cabinet(id)
);


create table tbl_reservation(
	id bigint unsigned primary key,
	parttime_id bigint unsigned,
	client_id bigint unsigned,
	constraint fk_reservation_parttime foreign key(parttime_id)
	references tbl_parttime(id),
...
create table tbl_child(
	...
	child_gender enum('남성', '여성') not null
);
...
create table tbl_parent(
	...
	parent_gender enum('남성', '여성') not null,
...
create table tbl_member(
	id bigint unsigned primary key,
	child_id bigint unsigned,
	constraint fk_member_child foreign key(child_id)
	references tbl_child(id)
);
...
create table tbl_kindergarten(
	...
	constraint fk_kindergaten_member foreign key(member_id)
	references tbl_member(id)
);
...
create table tbl_field_trip(
	...
	field_trip_contents varchar(255) not null,
	file_id bigint unsigned,
	member_id bigint unsigned,
	constraint fk_field_trip_file foreign key(file_id)
	references tbl_file(id),
	constraint fk_member_trip foreign key(member_id)
	references tbl_member(id)
);

create table tbl_apply(
	id bigint unsigned primary key,
	apply_check enum('success', 'fail') default 'fail',
...
create table tbl_category_A(
	...
	constraint fk_category_A_category_B foreign key(category_B_id)
...
create table tbl_category_B(
	...
	constraint fk_category_B_category_C foreign key(category_C_id)
...
create table tbl_category_C(
	...
	constraint fk_category_C_advertisement foreign key(advertisement_id)
...
create table tbl_company(
	...
	company_main_number bigint not null,
	company_type enum('스타트업', '중소기업', '중견기업', '대기업') not null,
	category_A_id bigint unsigned,
	constraint fk_company_category_A foreign key(category_A_id)
	references tbl_category_A(id)
);
...
create table tbl_company2(
	...
	company2_address varchar(255) not null,
	company2_number bigint not null
);
...
create table tbl_card_member(
	id bigint unsigned primary key,
	card_member_name varchar(255) not null
);
...
create table tbl_card(
	...
	card_member_id bigint unsigned,
	constraint fk_card_card_member foreign key(card_member_id)
	references tbl_card_member(id)
);
...
create table tbl_pay(
	id bigint unsigned primary key,
	company2_id bigint unsigned,
	product_id bigint unsigned,
	card_id bigint unsigned,
	user_id bigint unsigned,
	constraint fk_pay_company2 foreign key(company2_id)
